...
import 'package:toggle_provider/screen/SplashScreen.dart';

import 'package:toggle_provider/screen/TooglePage.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final themeProvider = Provider.of<ToggleProvider>(context);
    return MaterialApp(
      title: 'Flutter Demo',
      ...
      // home: const TooglePage(title: 'Provider App'),
      home: SplashScreen(nextPage: TooglePage(title: "Provider App")),
    );
    ...
    //   ),
    //   home: const TooglePage(title: 'Flutter Demo Home Page'),
    // );
  }
}
